...
<body>
  <nav class="navbar navbar-inverse navbar-static-top">
    ...
    <div class="row">
      <div class="col-md-6">
         <br />
         <center><img src="./resources/images/doctor-1149149_960_720.jpg" alt="image of dentist" width="80%" height="60%"></center> 
      </div>
      <div class="col-md-6">
        <br />
          <span style="display: inline-block; text-align: left; font-size: 24px;">
            <span style="color:white;">Our Phone:</span><br />
            555-123-4567<br />
            <br />
            <span style="color:white;">We Are Located At:</span><br />
            Yank'em Gently Dental<br />
            700 Geipe Road<br />
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <p>
          ...
          in use by the special forces. For the last 10 years he has been practicing dentistry
